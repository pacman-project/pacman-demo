...
namespace pacman {
	...
	public:
		...
		virtual void add(const std::string& id, const Point3D::Seq& points, const RobotUIBK::Pose::Seq& trajectory);
		...
		void convert(const ::grasp::RobotState::List& src, ShunkDexHand::Pose::Seq& dst) const;
		/** Trajectory conversion */
		void convert(const RobotUIBK::Pose::Seq& src, ::grasp::RobotState::List& dst) const;
