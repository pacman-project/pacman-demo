...
int main(int argc, char **argv)
{
    ...
    safe_state.handRight.wrist_pose.pose.position.x = 0.1624;
    safe_state.handRight.wrist_pose.pose.position.y = -0.2599;
    safe_state.handRight.wrist_pose.pose.position.z = 0.6642;
    safe_state.handRight.wrist_pose.pose.orientation.x = 0.404885;
    safe_state.handRight.wrist_pose.pose.orientation.y = 0.86333;
    safe_state.handRight.wrist_pose.pose.orientation.z = -0.139283;
